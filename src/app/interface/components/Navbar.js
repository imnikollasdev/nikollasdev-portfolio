          ...
          <div className={`hidden md:block`}>
            <ul className="flex items-center gap-24">
              ...
              <li className="text-[#9A9A9A] text-[1.6rem] font-semibold hover:text-[#F1F1F1] transition-all duration-500">
                <a
                  href="#about"
                  aria-label="Redirecionar para sessão de sobre."
                >
                  SOBRE
                </a>
              </li>
              ...
              <li className="text-[#9A9A9A] text-[1.6rem] font-semibold hover:text-[#F1F1F1] transition-all duration-500">
                <a
                  href="#projects"
                  aria-label="Redirecionar para sessão de projetos."
                >
                  PROJETOS
                </a>
              </li>
      ...
      {showMenu && (
        <div className="fixed w-screen h-screen bg-[#F1F1F1] z-10">
          <div className="p-5 w-full flex items-center justify-between">
            ...
            <div
              className={`cursor-pointer text-black md:hidden hover:text-red-500 transition-all duration-500`}
            >
          ...
          <ul className="p-5 space-y-10">
            <li className="text-black text-[1.5rem] font-semibold">
              <a
                href="#home"
                aria-label="Redirecionar para home."
                onClick={toggleMenu}
              >
                HOME
              </a>
          ...
          <div className="w-full absolute bottom-5">
            <h1 className="text-black text-center text-[1.3rem]">
