...
import { Animation } from "@/app/interface/components/Anim";
...
export default function Home() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      setLoading(false);
      return toast.error("Sistema de Contato em Desenvolvimento!");
  ...
  return (
    <>
      <section
        id="home"
        className="py-[17.0rem] w-full h-full flex items-center justify-center relative md:min-h-screen md:py-0"
      >
        <Image
        ...
        <Animation>
          <div className="p-4 max-w-[90.0rem] flex flex-col items-center">
            <h1 className="text-[#9A9A9A] text-[2.5rem] text-center font-extrabold sm:text-[6.0rem]">
              E AÍ, EU SOU NIKOLLAS GREGORY
            </h1>

            <h2 className="mt-16 mx-auto max-w-[90%] text-[1.5rem] text-center sm:text-[2.2rem]">
              Sou um estudante de <b>ADS</b> e atuo como Freelancer na plataforma MTA
            </h2>
      ...
      <section id="about" className="w-full h-full bg-[#242424]">
        <Animation>
          <div className="pt-[12.0rem] mx-auto max-w-[95.0rem]">
            <h1 className="text-[#9A9A9A] text-[3.5rem] text-center font-extrabold">
              SOBRE MIM
            </h1>
          ...
          <div className="px-[2.0rem] py-[12.0rem] mx-auto max-w-[120.0rem] grid gap-40 sm:grid-cols-2">
            <div className="w-full h-full">
              ...
              <p className="mt-[3.0rem] text-[#8A8A8A] text-[1.3rem] sm:text-[1.6rem]">
                Sou desenvolvedor de mods há 5 anos e domino a linguagem Lua. Possuo
                habilidades para criar projetos eficientes, otimizados e
                funcionais.
              </p>

              <p className="mt-[2.0rem] text-[#8A8A8A] text-[1.3rem] sm:text-[1.6rem]">
                Meu objetivo é entregar projetos de qualidade e escaláveis que
                atendam às necessidades específicas do projeto.
              </p>

              <p className="mt-[2.0rem] text-[#8A8A8A] text-[1.3rem] sm:text-[1.6rem]">
                Se você tiver uma boa oportunidade que corresponda às minhas
                habilidades e experiência, não hesite em entrar em contato
                comigo.
              </p>
            ...
            <div>
              <h3 className="text-[2.6rem] text-[#9A9A9A]">
                Minhas habilidades
              </h3>
              ...
              <div className="mt-[3.0rem] flex flex-wrap gap-5">
                {skills.map((value, index) => (
                  <div
                    key={index}
                    className="px-[2.0rem] py-[1.0rem] bg-[#1A1A1A] rounded-lg text-[#9A9A9A] text-[1.3rem] sm:text-[1.6rem]"
                  >
                    {value.name}
                  </div>
                ))}
      ...
      <section id="projects" className="w-full h-full relative">
        ...
        <Animation>
          <div className="pt-[12.0rem] mx-auto max-w-[95.0rem]">
            ...
            <h2 className="mx-auto mt-[2.0rem] max-w-[90%] text-[1.5rem] text-center sm:text-[2.2rem]">
              Aqui você encontrará uma seleção dos projetos que desenvolvi para
              clientes, assim como alguns dos meus projetos pessoais.
            </h2>
          </div>
            ...
            {projects.map((value, index) => (
              <div key={index} className="mx-auto grid gap-16 md:grid-cols-2">
                ...
                <div className="my-auto">
                  <h3 className="text-[#9A9A9A] text-[2.0rem] sm:text-[2.8rem]">
                    {value.name}
                  </h3>

                  <h2 className="mt-[3.0rem] text-[1.5rem] sm:text-[1.8rem]">
                    {value.description}
                  </h2>
        ...
        <Animation>
          ...
          <div className="px-10 py-[12.0rem] max-w-[80.0rem] mx-auto">
            <form
              ...
              className="p-10 rounded-xl bg-[#1A1A1A] border-2 border-[#242424]"
            >
              <div>
              ...
              >
                {isLoading ? (
                  <div className="w-full h-full flex items-center justify-center">
                    ...
                    <span className="relative p-2 text-[1.5rem]">
                      Carregando...
                    </span>
                  </div>
                ) : (
